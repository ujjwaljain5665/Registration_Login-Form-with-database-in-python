...
class login:
    ...
    def __init__(self,window):
        ...
        #canvas
        self.canvas = Canvas(self.window, width=400, height=460,bg="black",bd=0,relief='ridge',highlightthickness=0)
        self.canvas.place(x=200,y=90)

        clocktitle=Label(self.canvas,text="Developer's Clock",font=("times new roman",25,"bold"),bg="white",fg="red").place(x=80,y=4)
        #digi clock
        self.clock=Label(self.canvas,text="00:00:00",font="helvetica 40 bold",bg="black",fg="yellow")
        self.clock.place(x=0,y=390,width=400,height=70)
        # clock image
        self.bg = PhotoImage(file='Images/clock.png')
        self.canvas.create_image(200, 220, image=self.bg)
